...
class SearchApp(tk.Tk):
    def __init__(self):
        ...
        colors = ["#0A192F","#112240","#1E3A8A","#2563EB","#3B82F6","#60A5FA","#93C5FD","#BFDBFE","#38BDF8","#0EA5E9","#0051FF","#67E8F9","#E0F2FE"]
        text = "Billie a melhor"
        
        for i, char in enumerate(text):
            tk.Label(title_frame, text=char, font=("Times New Roman", 56, "bold"), fg=colors[i % len(colors)], bg="#ffffff").pack(side="left")
