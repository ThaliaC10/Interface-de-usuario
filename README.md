...
janela = tk.Tk()
janela.title("Escolha uma musica da billie")
...
tk.Label(
    janela,
    text="Escolha uma musica da billie",
    font=("Arial", 15, "bold"),
    bg="#1B4F72",
    fg="white",
    pady=12
...
tk.Label(janela, text="1. Escolha um album (Combobox):",
...
combo = ttk.Combobox(
    ...
    values=["HMHAS", "WWAFAWDWG", "DSAM", "HTE"],
    font=("Arial", 11),
    width=24,
    state="readonly"
)
...
tk.Label(janela, text="2. Escolha uma música (Listbox):",
         font=("Arial", 11, "bold"), bg="#EBF5FB", fg="#1B4F72").pack(pady=(18, 4))
...
linguagens = ["Bittersuite", "WILDFLOWER", "Billie Bossa Nova", "bury a friend", "ocean eyes"]
...
def mostrar():
    ...
    if album == "Selecione...":
        messagebox.showwarning("Atenção", "Escolha um album no Combobox!")
        return

    if not indices:
        messagebox.showwarning("Atenção", "Escolha uma musica na Listbox!")
        return
