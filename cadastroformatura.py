...
class AppFormatura(tk.Tk):
    ...
    def create_widgets(self):
        ...
        subtitle = tk.Label(header_frame, text="Eilish Dreams", 
        ...
        self.ent_telefone = create_input(form_frame, "QUANTIDADE", 2, 1, width=25)
        
        # Tipo de Ingresso
        lbl_tipo = tk.Label(form_frame, text="ticket", font=("Segoe UI", 10, "bold"), bg=self.bg_color, fg=self.text_muted)
        ...
        self.btn_cadastrar = tk.Button(btn_frame, text="CADASTRAR TICKET", font=("Segoe UI", 12, "bold"), 
